...
-- Продукты
-- =========================
CREATE TABLE IF NOT EXISTS products_original (
    id bigserial not null PRIMARY KEY,
    id_product bigint UNIQUE NOT NULL,          -- Код товара из сетевого ритейла
    ed text,                              -- Единица измерения
    erpcode text,                        -- ERP код
    deleted BOOLEAN DEFAULT false,               -- Признак удаления
    name_original text NOT NULL,                  -- Название товара
    group_code text,                          -- Код группы
     group_name VARCHAR(200),                     -- Название группы
    vat integer DEFAULT 0,                 -- НДС
    name text,                      -- Название для просмотра
    description text,                      -- описание
    image text,                      --  фотографии
